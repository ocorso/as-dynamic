...
var dbDefaultPath = dynamicContent.Allstate_National_Feed__2017_Final_Allstate_National_Feed[0]; 
  ...
  //Set bg color
document.getElementById("atAd300x600").className += dbDefaultPath.Background_CSS_Class;
...
console.log(logo)
  ...
  img1.src = dbDefaultPath.Frame1_Image_300x600.Url;
  var img2 = document.getElementById('img2');
  img2.src = dbDefaultPath.Frame2_Image_300x600.Url;
  var img3 = document.getElementById('img3');
  img3.src = dbDefaultPath.Frame3_Image_300x600.Url;
  console.log(img3)
...
var dbDefaultPath = dynamicContent.Allstate_National_Feed__2017_Final_Allstate_National_Feed[0]; 
  ...
  switch (dbDefaultPath.Variation) {
    case asApp.type.A1:
      ...
      document.getElementById("frame4").className += dbDefaultPath.Frame3_300x600_Copy_CSS_Class;
      document.getElementById("landingCopy1").className += dbDefaultPath.End_Frame_300x600_Copy1_CSS;
      document.getElementById("landingCopy2").className += dbDefaultPath.End_Frame_300x600_Copy2_CSS;
      break;
