...
asApp.parseDynamicContent = function() {
  ...
  //oc: Set bg color
  var ad728x90bg = document.getElementById('atAd728x90');
  ...
  ad728x90bg.style.backgroundColor = dynamicContent.aslocalfeed_Allstate_Local_Feed[0].Background_Color;

  //oc: Map Images
  var img1 = document.getElementById('img1');
  img1.src = dynamicContent.aslocalfeed_Allstate_Local_Feed[0].Image1_728x90.Url;
  var img2 = document.getElementById('img2');
  img2.src = dynamicContent.aslocalfeed_Allstate_Local_Feed[0].Image2_728x90.Url;
  var img3 = document.getElementById('img3');
  img3.src = dynamicContent.aslocalfeed_Allstate_Local_Feed[0].Image3_728x90.Url;
...
asApp.addGetINFrameToTimeline = function() {
  ...
  tl.staggerFrom(getIN.lines, 0.2, {
    left: -728
  }, 0.07)
...
asApp.addImageFramesToTimeline = function($variation) {
  ...
  if ((asApp.variation == 'DW1') || (asApp.variation == 'DW2P')) {
    ...
    tl.staggerFrom(frame5.lines, 0.2, {
      left: -728
    }, 0.07)
  ...
  if (asApp.variation == 'DW2P') {
    ...
    tl.staggerFrom(frame6.lines, 0.2, {
      left: -728
    }, 0.07)
